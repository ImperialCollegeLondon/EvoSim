...
def test_random_dask_charging_point(rng, n=6):
    from evosim.supply import random_charging_points

    charging_points = random_charging_points(n, seed=rng, npartitions=1)
...
def test_random_charging_point_with_capacity(rng):
    from evosim.supply import random_charging_points
